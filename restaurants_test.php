    ...
    <body>
       ...
       <table class="center">
		...
		<td>
                    ...
                    <a href="restaurants.php?restaurant=the-island"><img src="images/r7.jpg" width="300" height="225" alt="R7"/></a>
        
                <td>
                    <h3 class="center">The Tulip</h3>
                    <a href="restaurants.php?restaurant=the-tulip"><img src="images/r2.jpg" width="300" height="225" alt="R2"/></a></td>
                
                <td>
                    <h3 class="center">The Depot</h3>
                    <a href="restaurants.php?restaurant=the-depot"><img src="images/r3.jpg" width="300" height="225" alt="R3"/></a></td>
           ...
           <tr><td></td></tr>
            <tr>
                <td>
                    ...
                    <a href="restaurants.php?restaurant=fresh-garden"><img src="images/r4.jpg" width="300" height="225" alt="R4"/></a>
		</td>
                <td>
                    <h3 class="center">The Italian Lane</h3>
                    <a href="restaurants.php?restaurant=the-italian-lane"><img src="images/r5.jpg" width="300" height="225" alt="R5"/></a>
		</td>
                <td>
                    <h3 class="center">Waterfront Pizza</h3>
                    <a href="restaurants.php?restaurant=waterfront-pizza"><img src="images/r6.jpg" width="300" height="225" alt="R6"/></a>
		</td>
           </tr>
           <tr><td></td></tr>
           <td></td>
		...
		<td>
                    ...
                    <a href="restaurants.php"><img src="images/r1.jpg" width="300" height="225" alt="R1"/></a>
		</td>
                <td>
		    ...
		    <a href="restaurants.php">
                        <?php echo '<a class="image-link" href="https://chart.googleapis.com/chart?cht=qr&chs=300x225&chl=', urlencode($qrJson),'">' ?>
